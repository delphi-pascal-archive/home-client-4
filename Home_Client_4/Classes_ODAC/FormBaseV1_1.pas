...
uses
  ...
  Dialogs, FormBaseV_edit1, DBGridEh, Menus, OraSmart, DB, MemDS, DBAccess, Ora,
...
//        Начальное оформление формы (потомок)
//--------------------------------------------------------
procedure TFormBaseV1.FORM_MAININIT(GLSESSION:TOraSession;Sender: TObject);
var
   i:integer;
